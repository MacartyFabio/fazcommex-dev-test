...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dues', function (Blueprint $table) {
            ...
            $table->longText('informacoes_complementares')->nullable()->default(null);
            $table->decimal('total_vmle_moeda',17,2)->nullable()->default(null);
            $table->decimal('total_vmcv_moeda',17,2)->nullable()->default(null);
            $table->decimal('total_peso_liquido',17,5)->nullable()->default(null);
